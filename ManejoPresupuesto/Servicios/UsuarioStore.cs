...
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore
        <Usuario>
    {
        private readonly IRepositorioUsuarios repositorioUusarios;

        public UsuarioStore(IRepositorioUsuarios repositorioUusarios)
        {
            this.repositorioUusarios = repositorioUusarios;
        }
        public async Task<IdentityResult> CreateAsync(Usuario user, CancellationToken cancellationToken)
        {
            user.Id = await repositorioUusarios.CrearUsuario(user);
        ...
        {
            return await repositorioUusarios.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await repositorioUusarios.BuscarUsuarioPorEmail(normalizedUserName);
        }
