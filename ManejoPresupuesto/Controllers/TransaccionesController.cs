...
namespace ManejoPresupuesto.Controllers
{
    ...
    {
        private readonly IServicioUsuarios servicioUsuraios;
        ...
        public TransaccionesController(IServicioUsuarios servicioUsuraios, IRepositorioCuentas repositorioCuentas,
        ...
        {
            this.servicioUsuraios = servicioUsuraios;
        ...
        {
            var usuarioId = servicioUsuraios.ObtenerUsuarioId();
        ...
        [HttpGet]
        public async Task<FileResult> ExportarExcelPorMAño(int año)
        {
