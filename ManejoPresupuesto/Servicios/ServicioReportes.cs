...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioReportes : IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            ...
            var modelo = GenerarReporteTransccionesDetalladas(fechaInicio, fechaFin, transacciones);
        ...
        private void AsignarValoresAlViewBag(dynamic ViewBag, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            //Obtener la ruta de la vista donde me encuentro
            ViewBag.UrlRetorno = httpContext.Request.Path + httpContext.Request.QueryString;
        }

        private static ReporteTransaccionesDetalladas GenerarReporteTransccionesDetalladas(DateTime fechaInicio, DateTime fechaFin, IEnumerable<Transaccion> transacciones)
        {
